...
int main()
{
    ...
    auto noop = []([[maybe_unused]] const Value& value, [[maybe_unused]] std::size_t level) -> void {};
    ...
    { // sum values in tree
        int sum = 0;
        auto count = [&sum](const Value& value, [[maybe_unused]] std::size_t level) -> void { sum += value.a; };
