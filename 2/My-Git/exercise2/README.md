...
> **ℹ️ Note:** This repository is a copy of the homework submission by **Henadii Chalyi** for the course **Systems Programming (Systemnahes Programmieren)** at **TU Wien**.
...
All tasks have been successfully compiled (`g++ -std=c++20`) and verified. The local tests pass without any errors:

- **Task 1**: Successfully finds the correct minimum value (`-1024`).
- **Task 2**: `task2.test.cpp: all asserts passed`
- **Task 3**: `task3.test.cpp: all asserts passed`

Everything is fully functional and ready for submission.
